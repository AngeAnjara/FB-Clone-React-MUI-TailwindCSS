import { Typography, Avatar, Box, Container, IconButton } from "@mui/material";
...

    {
     ...
     >
      ...
      <Box sx={{justifyContent:"space-between"}}>
        <IconButton className="dark:text-slate-100"><Favorite sx={{fontSize:40}} />{item.like}</IconButton>
        <IconButton className="dark:text-slate-100"><InsertCommentIcon sx={{fontSize:40}} /></IconButton>
        <IconButton className="dark:text-slate-100"><ShareIcon sx={{fontSize:40}} /></IconButton>
      </Box>
      </Container>
      })
